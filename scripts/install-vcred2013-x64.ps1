...
#-------------------------------------------------------------------------------
Write-Host "Installing Visual C++ 2013 Redistributable (x64) ..." -ForegroundColor Cyan
...
Write-Host "Visual C++ 2013 Redistributable (x64) installed" -ForegroundColor Cyan
